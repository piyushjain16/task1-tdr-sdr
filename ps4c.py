...
class SubMessage(object):
    ...
    def build_transpose_dict(self, vowels_permutation):
        ...
        '''
        self.dict={'a':vowels_permutation[0],'e':vowels_permutation[1],'i':vowels_permutation[2],'o':vowels_permutation[3],'u':vowels_permutation[4]}
        return self.dict
